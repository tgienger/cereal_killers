...
angular.module('synergy.composer', [])
    ...
    .directive('synergyComposer', ['$timeout', function ($timeout) {
        return {
            ...
            transclude: true,
            scope: {synergyController: '=', synergySubmit: '&', topics:'=', exitComposer: '&'},
            link: function(scope, element, attrs, createPostCtrl) {
                ...
                scope.synergyController = scope.composerController = {
                    ...
                    reset: function() {
                      ...
                      this.newPost.topic = '';
                      this.newPost.markdown = '';
                      this.newPost.comment = undefined;
                      this.newPost.post = undefined;
                      return this;
                    },
                ...
                scope.submit = function() {
                  scope.synergySubmit()(scope.synergyController.newPost);
                }
                ...
                scope.$watch('composerController.comment', function(val) {
                  var disabled = false;
                  if (val) {
                    disabled = true;
                  }
                  angular.element('#topicSelect').attr({disabled:disabled});
                  angular.element('#composer_subject').attr({disabled:disabled});
                });
